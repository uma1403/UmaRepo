...
public class TC01_Login_Excel {
	...
	public static Object[][] Authentication1() throws Exception {
		...
		Object[][] testObjArray = T1.getTableArray("C://HTML Report//OrangeHRM6//TC01_Nationality1.xlsx", "Sheet1");
		System.out.println(testObjArray.length);
		return (testObjArray);
	}
	
  @Test(dataProvider="TC01_Add_Nationality")//Step2
  public void Login_Test(String TestURL,String UserName,String Password,String NationalityText) throws Exception{
