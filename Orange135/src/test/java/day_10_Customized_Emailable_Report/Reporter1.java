...
public class Reporter1
{
	...
	Date now5 = new Date();
	String strDate = sdfDate5.format(now5);

	String OutputFolder1 ="C:\\HTML Report\\test-output\\TempScreenShots";
	//OutputFolder = OutputFolder1 	+ "\\" + "New_Folder_" +  strDate;
	OutputFolder = OutputFolder1 	+ "\\" + TestName +"_"+  strDate; 
...
/*	@Test
	...
	*/
	...
	{
		  String PassIcon  ="C:\\HTML Report\\HtmlTemplates\\passed.ico";
		  String FailIcon  ="C:\\HTML Report\\HtmlTemplates\\failed.ico";
