...
/*
 ...
 fis = new FileInputStream(xlFilePath);
    ...
    public  Map<String, HashMap<String, String>> getDataTable(String xlFilePath,String sheetName) throws Exception
   	{
           ...
           int columnsCount=getColumnCount(xlFilePath,sheetName);
           int rowsCount=getRowCount(xlFilePath,sheetName);
           ...
           for ( int i=1 ; i<rowsCount ;i++)  
   	    {
           	...
           	HashMap<String, String> HM1 = new HashMap<String, String>();
   	    	  ...
   	    	  for ( int j=1;j<columnsCount ;j++) 
   	    	   {
   	    		    ...
   	    		    row = sheet.getRow(i);  //Data
   	    	        cell = row.getCell(j); //Data
   	    	        
   	    	           row1 = sheet.getRow(0);
   	    	           cell1 = row1.getCell(j);//Data Header
   	    	       
   	    	      
   	    	         // System.out.println("Cell Data: " + cell.getStringCellValue());
   	    	        
   	    	       
   	    	        HM1.put(cell1.getStringCellValue(), cell.getStringCellValue());
   	    	  ...
   	    	  XSSFRow   row2 = sheet.getRow(i);
     	          XSSFCell  cell2 = row2.getCell(0);//TC01 
   	    	  Datatable.put(cell2.getStringCellValue(), HM1);
