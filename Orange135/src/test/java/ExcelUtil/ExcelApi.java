...
public class ExcelApi {
    ...
    static String filePath,sheetName;

	public static void main(String[] args) throws IOException {
		
		ExcelApi obj=new ExcelApi();
		
		obj.getData_From_Excel(filePath,sheetName);
	}
	
	public Map<String, HashMap<String, String>> getData_From_Excel(String filePath1,String sheetName1) throws IOException {
